...
<div class="content-wrapper">
    ...
    <!-- needs to be done in single.blade.php -->
     ...
     <div class="container">
         <div class="row medium-padding120">
             <main class="main">
                 <div class="col-lg-10 col-lg-offset-1">
                     <article class="hentry post post-standard-details">
                         ...
                         <div class="socials text-center">
                             <div class="addthis_inline_share_toolbox_n75s"></div>
                         </div>
                 ...
                 <!-- End Sidebar-->
                 <!-- Needs to be in single.blade.php -->
...
@include('includes.toastr_subscribe')
<!-- ...end JS Script -->
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5b8ff59532dbb6c5"></script>
